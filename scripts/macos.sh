...
# This script modifies the macOS system preferences to my preferred values. 
...
debug_step "Making system modifications..."
...
defaults write -g NSSystemFontSize -int 11
# defaults write -g NSBoldSystemFont LucidaGrande-Bold
defaults write -g NSBoldSystemFontSize -int 11
# defaults write -g NSFont Helvetica
defaults write -g NSFontSize -int 11
...
defaults write -g NSMessageFontSize -int 11
...
defaults write -g NSToolTipsFontSize -int 10
# defaults write -g NSTitleBarFont LucidaGrande
defaults write -g NSTitleBarFontSize -int 11
...
defaults write com.apple.dock autohide-delay -float 0.96
